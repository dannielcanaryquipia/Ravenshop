...
<section class="checkout-orders">
   ...
   <h3>Your Orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Address 1 :</span>
            <input type="text" name="flat" placeholder="Street name" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Address 2 :</span>
         ...
         <div class="inputBox">
            <span>ZIP CODE :</span>
            <input type="number" min="0" name="pin_code" placeholder="e.g. 4706" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="box" required>
         </div>
      </div>
